...
from quiz.models import Answer, Quiz, QuizTaker, UsersAnswer
from quiz.serializers import MyQuizListSerializer, QuizListSerializer, QuizDetailSerializer, UsersAnswerSerializer
...
class QuizDetailAPI(generics.RetrieveAPIView):
    ...
    def get(self, *args, **kwargs):
        ...
        if created:
            for question in Quiz.objects.filter(quiz=quiz): #Quiz when register for quizzes
